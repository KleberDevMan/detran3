...
@Entity
@NamedQueries({
    @NamedQuery(name = "Usuario.autentica", query = "SELECT u FROM Usuario u WHERE u.usuario = :usuario and u.senha = :senha and u.tipoUsuario = :tipo")
        ,@NamedQuery(name = "Usuario.listar", query = "SELECT u FROM Usuario u WHERE u.tipoUsuario = :tipo")})
public class Usuario implements Serializable {
    ...
    public Usuario(Integer idusuario2) {
